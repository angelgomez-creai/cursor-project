...
### 🎯 Video Principal: Configuración y Workspace

Aprende a configurar tu workspace óptimo y establecer la estructura de proyecto perfecta.

<iframe 
  width="100%" 
  height="400" 
  src="https://www.youtube.com/embed/5zR1ZE5aqho" 
  title="Configuración y Workspace en Cursor AI" 
  frameborder="0" 
...
### 🛠️ Video Complementario: Setup Avanzado

Configuraciones avanzadas y personalización de tu entorno de desarrollo.
